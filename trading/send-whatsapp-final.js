#!/usr/bin/env node
/**
 * Envia WhatsApp direto via Z-API
 * Run: node send-whatsapp-final.js
 */
    ...
    const req = https.request(options, (res) => {
      ...
      res.on('end', () => {
        if (res.statusCode === 200) {
          console.log(`✅ ${tester.nome}: ENVIADO!`);
          resolve({ tester, status: 'success', response: body });
        } else {
...
async function sendAll() {
  console.log('🚀 ENVIANDO MENSAGENS PARA 8 TESTERS...\n');
